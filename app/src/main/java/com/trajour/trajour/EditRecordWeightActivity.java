...
public class EditRecordWeightActivity extends AppCompatActivity implements View.OnClickListener, DatabaseReference.CompletionListener {
    ...
    private View.OnClickListener mOnDateClickListener = new View.OnClickListener() {
        ...
        public void onClick(View v) {
            DatePickerDialog datePickerDialog = new DatePickerDialog(EditRecordWeightActivity.this,
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mEditHeight1.setText(mRecordWeight.getHeight());

        mEditBodyWeight1 = (EditText) findViewById(R.id.editWeight1);
        mEditBodyWeight1.setText(mRecordWeight.getBodyWeight());

        mEditBodyFatPercentage1 = (EditText) findViewById(R.id.editBodyFatPercentage1);
        mEditBodyFatPercentage1.setText(mRecordWeight.getBodyFatPercentage());
    ...
    private void showAlertDialog() {
        ...
        alertDialogBuilder.setMessage("削除しますが、よろしいですか？");
